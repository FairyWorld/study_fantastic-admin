...
<p><img :src="$withBase('/vue2/basic-layout-default.png')" /></p>
...
<p><img :src="$withBase('/vue2/basic-layout-without-main-sidebar.png')" /></p>
...
## 扩展 <Badge type="tip" text="专业版" vertical="top" />
